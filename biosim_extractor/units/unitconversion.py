...
class UnitConverter:
    ...
    def __init__(self, standard_units: Optional[Dict[str, str]] = None) -> None:
        ...
        self.factors: Dict[str, Dict[str, Any]] = {
            'length': {
                'Å': 0.1, 'A': 0.1, 'Ang': 0.1, 'angstrom': 0.1, 
                'nm': 1.0, 'pm': 0.001, 'm': 1e9
            },
            'volume': {
                'nm^3': 1, 'A^3': 1000, 'Å^3': 1000, 'Ang^3': 1000
            },
            'time': {
                'fs': 0.001, 'ps': 1.0, 'ns': 1000.0, 
                's': 1e12
            },
            'energy': {
                'kcal/mol': 4.184, 'kJ/mol': 1.0, 'eV': 96.485,
                'J': 6.022e20, 'hartree': 2625.5
            },
            'force': {
                'kcal/mol/Å': 41.84, 'kJ/mol/nm': 1.0,
            },
            'temperature': {
                'K': 1.0, 'C': lambda x: x + 273.15,
            ...
            'compressibility': {
                '1/bar': 1.0, 'bar^-1': 1.0, '1e10-6 bar^-1': 1e-6,
            },
            'frequency': {
                'ps^-1': 1.0, '1/ps': 1.0, 'fs^-1': 1000.0, '1/fs': 1000.0,
                'GHz': 1e-3, 'THz': 1e-6, 'Hz': 1e-12
            },
            'friction': {
                'a/ps': 1.0, 'amu/ps': 1.0,
            },
